...
/**
 * This is a partial implementation of a SortedArrayList class. The class
 * extends ArrayList (which provides most of the functionality) and rewrites the
 * implementation of a select set of methods to ensure that elements within the
 * sorted array are organized in ascending order. Only a few of the methods have
 * been optimized for a sorted array. The methods that have been optimized are
 * explicitly overridden in this subclass.<br />
 * <br />
 * The following methods have been overridden as unsupported since they do not
 * make sense in the context of a sorted container:<br />
...
public class SortedArrayList<E extends Comparable<? super E>> extends ArrayList<E> implements List<E>, RandomAccess {
	 ...
	 * <tt>(o==null&nbsp;?&nbsp;e==null&nbsp;:&nbsp;o.equals(e))</tt>. Makes use
	 * of a binarySearch to achieve O(log n) execution time.
	 *
	 * @param target
	...
	/**
	 * Adds the specified element to the list while maintaining sorted order.
	 * <br />
	 * <br />
	 * Uses binarySearch to find the location to insert the element and then
	 * calls add(int, E) to do the inserting.
	 *
	 * @param value
	...
	/**
	 * Adds all of the elements in the specified collection to this list and
	 * ensures that they are in sorted order.
	 * 
	 * @param collection
	 ...
	 *             so that a client cannot cannot corrupt the sorted order of
	 *             the list.
	 */
	@Override
	 ...
	 * no such index.<br />
	 * <br />
	 * Makes use of binarySearch to find the index. If the item is not found,
	 * the index is set to -1 to match the interface specification.
	 *
	 * @param target
